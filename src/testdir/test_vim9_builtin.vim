...
def Test_get()
  v9.CheckSourceDefAndScriptFailure(['get("a", 1)'], ['E1013: Argument 1: type mismatch, expected list<any> but got string', 'E1530: Argument of get() must be a List, Tuple, Dictionary or Blob'])
...
def Test_index()
  ...
  v9.CheckSourceDefAndScriptFailure(['index("a", "a")'], ['E1013: Argument 1: type mismatch, expected list<any> but got string', 'E1527: List or Tuple or Blob required for argument 1'])
...
def Test_join()
  v9.CheckSourceDefAndScriptFailure(['join("abc")'], ['E1013: Argument 1: type mismatch, expected list<any> but got string', 'E1528: List or Tuple required for argument 1'])
...
def Test_max()
  ...
  var l2: list<number> = g:flag
          ...
          : [4, 5]
  assert_equal([4, 5], l2)
  v9.CheckSourceDefAndScriptFailure(['max(5)'], ['E1013: Argument 1: type mismatch, expected list<any> but got number', 'E1529: List or Tuple or Dictionary required for argument 1'])
enddef
...
def Test_min()
  ...
  var l2: list<number> = g:flag
          ...
          : [4, 5]
  assert_equal([4, 5], l2)
  v9.CheckSourceDefAndScriptFailure(['min(5)'], ['E1013: Argument 1: type mismatch, expected list<any> but got number', 'E1529: List or Tuple or Dictionary required for argument 1'])
enddef

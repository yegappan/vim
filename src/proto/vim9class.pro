...
void copy_enum(typval_T *from, typval_T *to);
void typealias_free(typealias_T *ta);
void enum_unref(enum_T *en);
int enum_free_nonref(int copyID);
int set_ref_in_enums(int copyID);
int get_enum_tv(enum_T *en, char_u *name, size_t namelen, typval_T *rettv);
int enum_index(char_u **arg, typval_T *rettv, evalarg_T *evalarg, int verbose);
int check_enum_value(enum_T *en, int value);
